...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nome_responsavel_setor = trim($_POST['nome_responsavel_setor']);
    $id_secretaria = intval($_POST['id_secretaria']);

    $sql = "INSERT INTO setor (nome_setor, telefone, endereco, nome_responsavel_setor, id_secretaria) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssi", $nome_setor, $telefone, $endereco, $nome_responsavel_setor, $id_secretaria);

    if ($stmt->execute()) {
        $mensagem = "<div class='alert alert-success mt-3'>Setor cadastrado com sucesso!</div>";
    } else {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item"><a class="nav-link active" href="cadastro_setor.php"><i class="bi bi-geo-alt"></i> Setor</a></li>
    ...
    <main class="container-fluid">
        <h2 class="mb-4">Cadastro de Setor</h2>
        ...
        <form method="POST" class="form-section">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="telefone" id="telefone" class="form-control" placeholder="(99) 99999-9999">
                </div>
                <div class="col-12 col-md-6">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="nome_responsavel_setor" class="form-control" required>
                </div>
                <div class="col-12 col-md-6">
